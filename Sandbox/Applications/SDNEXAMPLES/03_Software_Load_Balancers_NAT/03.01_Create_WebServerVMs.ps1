...
.SYNOPSIS 
    ...
    This script:
     ...
     3. Adds WebServerVM1 and WebServerVM2 to the AzStackCluster
...
Set-VMNetworkAdapter -VMName WebServerVM1 -ComputerName AzSHOST2 -StaticMacAddress "00-11-22-33-44-60" | Out-Null
Set-VMNetworkAdapter -VMName WebServerVM2 -ComputerName AzSHOST1 -StaticMacAddress "00-11-22-33-44-61" | Out-Null

Write-Verbose "Connecting VMswitch to the VMNetwork Adapters on the Web Server VMs "

Get-VMNetworkAdapter -ComputerName AzSHOST2 -VMName WebServerVM1 | Connect-VMNetworkAdapter -SwitchName sdnSwitch | Out-Null
Get-VMNetworkAdapter -ComputerName AzSHOST1 -VMName WebServerVM2 | Connect-VMNetworkAdapter -SwitchName sdnSwitch | Out-Null



Write-Verbose "Starting the Web server VMs"
# Start the VMs
Start-VM -Name WebServerVM1 -ComputerName AzSHOST2
Start-VM -Name WebServerVM2 -ComputerName AzSHOST1


Write-Verbose "Getting MAC Addresses of the NICs for the VMs so we can create NC objects "
# Get the MACs
$WebServerVM1Mac = (Get-VMNetworkAdapter -VMName WebServerVM1 -ComputerName AzSHOST2).MacAddress
$WebServerVM2Mac = (Get-VMNetworkAdapter -VMName WebServerVM2 -ComputerName AzSHOST1).MacAddress
...
Add-ClusterVirtualMachineRole -VMName WebServerVM1 -Cluster AzStackCluster | Out-Null
Add-ClusterVirtualMachineRole -VMName WebServerVM2 -Cluster AzStackCluster | Out-Null
